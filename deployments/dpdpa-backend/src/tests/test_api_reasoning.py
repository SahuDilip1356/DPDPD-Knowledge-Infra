...
class TestApiGateway:
    ...
    def test_get_ingestion_audit(self):
        ...
        with open(INGESTION_LOG_PATH, "a") as f:
            f.write(json.dumps({
                "timestamp": "2026-07-28T02:49:41.627391Z", 
        ...
        assert data["logs"][0]["pipeline_id"] == "pipeline-test"

    def test_get_bible_content(self):
        """GET /knowledge/bible should return bible markdown content."""
        res = client.get("/knowledge/bible")
        assert res.status_code == 200
        data = res.json()
